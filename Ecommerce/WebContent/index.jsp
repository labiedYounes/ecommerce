		...
		<div class="inner">
			...
			<div id="header">
				<div class="header-inner">
					...
					<div class="shell">
						<h1 id="logo">
							<a class="notext" href="#">Notre LOGO</a>
						</h1>
						<div id="account">
							<a class="view-account" title="View Account" href="#">Votre
								Pannier</a> <span>Articles: 4</span><span>Prix:<strong>250.90
									Dh</strong></span>
							<div class="cl">&nbsp;</div>
						</div>
						<!-- Begin Navigation -->
			...
			<div class="shell">
				...
				<div id="main">
							...
							<li class="widget">
								...
								<div id="search">
									<form action="authentification" method="get"
										...
										<Label> Login : </Label> <input type="text" class="blink"
											name="login" /> <label>Mot de Passe</label> <input
											type="text" class="blink" name="mdp" /> <span><input
											type="submit" value="Se connecter" /></span> <span
											onclick="ouvrir(400,300,'Inscription.html')"><input
											type="submit" value="S'inscrire" /></span>
										<div class="cl">&nbsp;</div>
									</form>
							...
							<li class="widget">
								...
								<div id="search">
									<form action="#" method="get" accept-charset="utf-8">
										Entrez un nom de produit <input type="text" class="blink"
											name="keyword" /> <label>Categorie</label> <select size="1"
											name="category">
										...
										<div class="price">
											<label>Prix </label> <select size="1" name="price">
											...
											</select> <label>Dh et:</label> <select size="1" name="to">
												<option value="50">50</option>
												<option value="60">60</option>
												<option value="70">70</option>
												<option value="80">80</option>
					...
					<div id="content">
						...
						<div id="products">
							<div class="product">
								<img src="css\images/product-img1.jpg"
							...
							<div class="product">
								<img src="css\images/product-img2.jpg"
							...
							<div class="product last">
								<img src="css\images/product-img3.jpg"
					...
					<div id="pr-slider">
						<ul>
							<li><a href="#"><img src="css\images/slide-img1.jpg"
									alt="Slide TShirt 1" /></a></li>
							<li><a href="#"><img src="css\images/slide-img2.jpg"
									alt="Slide TShirt 2" /></a></li>
							<li><a href="#"><img src="css\images/slide-img3.jpg"
									alt="Slide TShirt 3" /></a></li>
							<li><a href="#"><img src="css\images/slide-img4.jpg"
									alt="Slide TShirt 4" /></a></li>
							<li><a href="#"><img src="css\images/slide-img5.jpg"
									alt="Slide TShirt 5" /></a></li>
							<li><a href="#"><img src="css\images/slide-img6.jpg"
									alt="Slide TShirt 6" /></a></li>
							<li><a href="#"><img src="css\images/slide-img7.jpg"
					...
					<div id="home-boxes">
						...
						<div class="box first">
							...
							<div class="box-entry">
								...
								<p class="more">
									<a href="#" title="Read More">Lire la suite</a>
								</p>
							</div>
						</div>
						<!-- End Box -->
				...
				<div id="footer">
					<p class="bottom-menu">
						<a href="#" title="Home Page">Home</a><span>|</span><a href="#"
							title="Support Page">Support</a><span>|</span><a href="#"
							title="My Account Page">My Account</a><span>|</span><a href="#"
							title="Store Page">The Store</a><span>|</span><a href="#"
							title="Contact Page">Contact</a>
					</p>
					<p>
						&copy; 2013 Réalisé Par : <a href="http://www.fsr.ac.ma/">LP
							Qualité Logiciel</a>
					</p>
					<div class="cl">&nbsp;</div>
				</div>
